...
fixtures.generate:
	...
	$(shell USER_ID=1000 chmod u+x ./fixtures-generator/entrypoint.sh && docker-compose -f docker-compose.yaml -f docker-compose-tests.yaml -f docker-compose-tests-dev.yaml up fixtures-service)
