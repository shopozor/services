export default {
  budzons: {
    ...
    description: `
      <p class="mb-5">
        Cette année, en 2020, nous, les Budzons, avons décidé de nous associer pour mener à bien ce projet. Carlos, portugais fribourgeois, papa de deux enfants
        et mari dévoué à sa famille ainsi qu'à la cause environnementale met un point d'honneur à simplifier la transition de nos foyers vers une consommation plus
        écologique. Avec une interface agréable, autant virtuellement que sur le terrain, il veille à ce que la Budzonnerie permette aux Consommateurs d'acheter
        des Produits locaux et respectueux de l'environnement tout en aidant le tissu économique local à se développer.
      </p>
      <p class="mb-5">
        De son côté, Rémi, pur fribourgeois, petit-fils et neveu d'agriculteur, a passé une grande partie de sa vie au contact du monde paysan. Boulanger-pâtissier de formation,
        il aime les produits régionaux et de qualité. Son but premier est que la Budzonnerie produise et vende de la qualité à un prix juste en faisant valoir le travail des
        Producteurs. Les Producteurs doivent pouvoir vendre leurs Produits très facilement de sorte à pouvoir se consacrer au maximum à leurs marchandises. Avec la Budzonnerie,
        les Producteurs produisent seulement ce qui a été vendu, ce qui permet de réduire le gaspillage de leurs Produits.
      </p>
      <p class="mb-5">
        Même si les deux geeks en puissance précités s'y connaissent plutôt bien en informatique, ils n'ont évidemment aucune idée de la confection de logiciel. C'est là que Laurent,
        co-fondateur fribourgeois de <a href="http://softozor.ch" target="_blank">softozor</a>, entre en piste. Grâce à lui ainsi que ses associés Thomas, Cédric et Florian, ainsi que de
        ses coéquipiers Kilian et Nils, la technique se plie au service de notre commerce de proximité. Son équipe investit son temps libre pour trouver les solutions les plus
        pratiques et moins onéreuses possible, afin de produire elle aussi sa contribution artisanale pour sa région.
      </p>
    `
  },
  ...
  projectProgress: 'Avancement des développements'
}
